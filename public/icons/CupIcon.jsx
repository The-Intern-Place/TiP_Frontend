...
const CupIcon = () => {
  return (
    ...
    >
      <g clip-path="url(#clip0_2952_1148)">
        <path
          d="M6 27.9999C7.66 29.2839 10.154 30.0339 13 29.9999C15.846 30.0339 18.34 29.2839 20 27.9999C21.66 26.7159 24.154 25.9659 27 25.9999C29.846 25.9659 32.34 26.7159 34 27.9999"
          stroke="#0046BF"
          stroke-width="3"
