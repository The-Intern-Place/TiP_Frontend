...
const IC_People = (props: { className?: string }) => {
    return (
        <svg enable-background="new 0 0 24 24" id="Layer_1" version="1.0"
            width="48"
            height="48"
            viewBox="0 0 48 48"
            fill="none"
            ...
            <g>
                <g>
                    <circle cx="5.5" cy="8.5" r="2.5" fill={"#1976D2"}
                        className={props.className} />
                </g>
                <g>
