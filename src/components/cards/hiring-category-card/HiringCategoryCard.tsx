  ...
  return (
    <section>
      <div
       ...
       flex-col  relative md:w-[274px] w-full h-[184px] hover:bg-light-blue hover:stroke-white  gap-[32px]
        hover:text-white px-[2rem] border-2 border-[#D6DDEB] "
      >
        <p>{props.icon}</p>
        <h1 className="text-[24px] font-[600] leading-[40px]">{props.title}</h1>
      </div>
    </section>
  );
};
