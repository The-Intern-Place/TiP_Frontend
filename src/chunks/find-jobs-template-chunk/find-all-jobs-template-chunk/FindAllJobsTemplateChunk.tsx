...
{/*  */}
<div className="flex gap-[8px] pt-[12px] pr-[16px] pb-[12px] pl-[16px] items-center justify-center md:hidden
 w-[100%] h-[50px] border-[1px] border-r-0 border-l-0 border-[#515B6F33] mt-[40px] px-0"  onClick={handleFilterToggle}>
  <Image src={filtericon}  alt="filter_icon"  className="w-[24px] h-[24px]" />
  <h1 className="font-[500] text-[16px] leading-[25px] font-clash">More Filters</h1>
</div>



      {/* find job filter */}
      <div className={`p-1 px-2   gap-[20px] ${showFilter? "fixed" : "hidden md:flex md:flex-col"}  md:relative top-[30px] md:top-0 
...
<div  className="flex justify-between items-center md:hidden pt-[1rem] px-[0.25rem]">
  <h1  className="font-clash text-[#1B1B1B] font-[600] text-[20px] leading-[24px]">More Filter </h1>
  <Image onClick={handleFilterToggle} src={close} alt="close"  className="w-[14px] h-[14px]" />
</div>
