      ...
      <div className="flex  flex-col md:flex-row justify-center items-center gap-[20px]  lg:gap-[25px]">
        ...
        <div className="bg-[#F9FDFF] w-[87%] rounded-[20px]">
          <div className="lg:w-[350px] rounded-[20px] bg-[#FFFFFF] mx-[1rem] my-[1rem]">
            ...
            {/* first divider */}
            <div className="border-[1px] border-[#D6DDEB] mx-[0.7rem]"></div>

            <ul className="flex flex-col gap-[22px]  p-[1rem] mx-[0.5rem]">
              {[...new Array(6)].map((_price, index) => (
                <li key={index} className="gap-[6px] flex items-center ">
                  <Image src={good} alt="good" className="w-5 h-5 " />{" "}
            ...
            <div className="flex flex-col items-center justify-center  p-[10px]">
              ...
              <button className="bg-[#0046BF] w-[147px] h-[42px] gap-[10px] text-[#FFFFFF] leading-[22px] text-[14px] font-[700] font-epilogue  ">
                Make a Payment
              </button>
            </div>
          </div>
