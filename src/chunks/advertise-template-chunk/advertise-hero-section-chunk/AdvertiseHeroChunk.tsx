    ...
    <section className="bg-[#FAFBFC]">
      <div className="flex justify-center items-center mx-auto flex-col gap-5 py-9">
        <div className="bg-[#FAFBFC] lg:w-[782px] text-center gap-[24px]">
          <h1 className="lg:text-5xl text-[36px] md:text- leading-[52px]  font-[600] font-clash"></h1>

          <h1 className="md:text-[48px] text-[36px] md:text- leading-[52px]  font-[600] font-clash">
            <span className="text-[#26A4FF] relative">
              Advertise{" "}
              <span
                className="absolute md:top-14 top-10 md:right-0 right-1 items-center 
               md:items-end "
              >
                <Image
                  alt=""
          ...
          {/* text */}
          <p className="text-center md:px-10 px-[1rem] lg:px-0 font-[400] font-epilogue py-4  w-[100%] leading-[32px] text-[16px] md:leading-[36px] leading-[32px] md:text-[18px] text-[#1B1B1B] md:mt-[2rem]">
