...
import IC_Design from "@assets/icons/IC_Design";
import { IC_Finance } from "@assets/icons/IC_Finance";
import IC_Manager from "@assets/icons/IC_Manager";
import IC_Marketing from "@assets/icons/IC_Marketing";
import React from "react";

const JobCategoryTemplateChunk = () => {
  const categories = [
    {
...
export default JobCategoryTemplateChunk;
