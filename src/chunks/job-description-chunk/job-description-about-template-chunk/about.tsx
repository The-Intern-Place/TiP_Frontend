...
function About(_props: FindJobCardProps) {
  const appliedPercentage = (Number(5) / Number(10)) * 100;
  return (
    <div className="mb-5">
      <div>
        ...
        <div className="bg-[#F8F8FD] pb-7 mb-10">
          ...
          <div className="md:w-[95%] w-[90%] h-[6px] rounded-[10px] bg-[#D6DDEB] mt-[1rem] ml-5">
            <div
