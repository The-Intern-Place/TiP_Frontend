...
const Assesment = () => {
  const { ITEMS_PER_PAGE, paginate, currentPage, currentassesmentdata } =
        ...
        <tbody>
          {currentassesmentdata.map((t) => (
            <tr key={t.id} className="border-[1px] border-b">
              ...
              >
                <h1 className="border-[#26A4FF] border-[1px] text-[#26A4FF] w-[107px]  h-[34px] rounded-[80px]  text-center flex items-center justify-center">
                  {t.statusAssesment}
                </h1>
              </td>
            </tr>
