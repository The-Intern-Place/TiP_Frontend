...
import ContactLinkTemplateChunk from "@/chunks/contact-template-chunk/contact-link-template-chunk/ContactLinkTemplateChunk";
      ...
      <main className="w-full h-full max-w-[1350px] mx-auto">
        ...
        <div className="overflow-hidden bg-white py-8 sm:py-16 sm:ml-16">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto mb-10 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-3 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
