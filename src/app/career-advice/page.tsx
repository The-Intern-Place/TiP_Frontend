...
import { advices } from "@/utils/data/career-advice";
import Image from "next/image";
import { SearchBlue, Underline } from "@assets/images";
      ...
      <section className="bg-[#FAFBFC]">
        <div className="flex justify-center items-center mx-auto flex-col gap-5 py-9">
          <div className="bg-[#FAFBFC] lg:w-[782px] text-center">
            ...
            <p className="text-center px-10 lg:px-0  py-4 leading-[36px] text-[#1B1B1B]">
