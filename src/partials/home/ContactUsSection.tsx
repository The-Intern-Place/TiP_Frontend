        ...
        <main className="w-full h-full max-w-[1350px] mx-auto">
            <div className="grid justify-items-center mb-10">
                ...
                <p className="text sm:w-3/6 mb-3 w-5/6">
                    We’d love to hear from you at The Intern Place. Contact Us for effective service.
                </p>
            </div>
                    ...
                    <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                        <div className="lg:pr-8 lg:pt-4">
                            <div className="lg:max-w-lg">
                                <p className="flex justify-center mt-2 text-2xl font-bold tracking-tight sm:text-2xl">Frequently Asked Questions</p>
                            ...
                            <div className="mt-10 flex justify-end gap-x-6">
                                <a href="#" className="text-sm font-semibold leading-6 text-[#1976D2]">
                                    See All <span aria-hidden="true">→</span>
                                </a>
                            </div>
                            <div>
                                <p className="flex justify-center mt-2 mb-10 text-3xl font-bold tracking-tight sm:text-2xl">Our Links</p>
                                <Link className='flex justify-center items-center mb-4' href={'#'}>
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 text-[#1976D2]">
                                        <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75" />
                                    </svg>
                                    <span className="text-sm text-[#1976D2] ml-3">theinernplacejobs@gmail.com</span>
                                </Link>
                        ...
                        <div className='shadow-lg ml-5 w-5/5 sm:w-4/5 mt-10'>
                            <p className="mt-2 text-xl text-[#1976D2] font-bold tracking-tight sm:text-xl ml-9 sm:mt-10">Send us a message</p>
                            <form className='text w-4/5 ml-9 sm:mt-20'>
                                <div className="p-2 w-full">
                                    <div className="relative">
                                        <label htmlFor="name" className="leading-7 py-4 text-xl font-bold tracking-tight sm:text-xl">Full Name</label>
                                ...
                                <div className="p-2 w-full">
                                    <div className="relative">
                                        <label htmlFor="email" className="leading-7 py-4 text-xl font-bold tracking-tight sm:text-xl">Your Email</label>
                                ...
                                <div className="p-2 w-full">
                                    <div className="relative">
                                        <label htmlFor="name" className="leading-7 py-4 text-xl font-bold tracking-tight sm:text-xl">Company Name</label>
                                        <input type="text" id="name" name="company name" required
                                            className=" w-full bg-white rounded border border-gray-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-900 py-1 px-1 leading-8 transition-colors duration-200 ease-in-out" />
                                    </div>
                                </div>
                                <div className="p-2 w-full">
                                    <div className="relative">
                                        <label htmlFor="message" className="leading-7 py-4 text-xl font-bold tracking-tight sm:text-xl">Message</label>
                                        <textarea id="message" name="message" required
                                            className=" w-full bg-white rounded border border-gray-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-200 h-32 text-base outline-none text-gray-900 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                    </div>
                                </div>
                            </form>
                        </div>
