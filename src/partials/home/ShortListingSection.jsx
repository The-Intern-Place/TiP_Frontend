  ...
  return (
    <main className="w-full h-full max-w-[1350px] mx-auto">
      <div className="grid justify-items-center mb-12">
        ...
        <Button overideStyles="border-0 rounded-none w-44 align-items-center">
          Contact Us
        </Button>
      </div>
      <div className="flex flex-col md:flex-row sm:ml-20">
        <div className="max-w-sm p-6 mt-12">
          ...
          <div className="flex flex-row">
            ...
            <Button overideStyles="border-2 rounded-none w-44 bg-white text-black">
              Reach Us
            </Button>
          </div>
        </div>

        <div class=" grid grid-cols-2 md:grid-cols-2 sm:flex-row flex-wrap mb-4 ml-4 gap-4">
