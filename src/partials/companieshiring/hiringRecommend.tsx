...
const HiringRecommend = () => {
  return (
<section className="bg-[#ffffff] overflow-x-hidden lg:px-16 flex justify-center items-center">
  <div className="flex flex-col w-full h-full max-w-[1350px] p-2 mx-0 xl:px-0
